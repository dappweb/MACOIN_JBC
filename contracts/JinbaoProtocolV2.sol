...
contract JinbaoProtocolV2 is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
     ...
     * @param user 用户地址
     * @return level 用户等级 (0-9)
     * @return percent 极差收益比例
     * @return teamCount 团队地址数量
     */
