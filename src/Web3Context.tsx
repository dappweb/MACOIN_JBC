...
export const PROTOCOL_ABI = [
  ...
  "function stakeRedemptionFeePaid(uint256 stakeId) view returns (uint256)",
...
export const CONTRACT_ADDRESSES = {
  JBC_TOKEN: import.meta.env.VITE_JBC_CONTRACT_ADDRESS || "0x1Bf9ACe2485BC3391150762a109886d0B85f40Da", // 正确的JBC合约地址（从协议合约查询确认）
